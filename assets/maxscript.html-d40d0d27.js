import{_ as e,V as n,W as i,a2 as l}from"./framework-5f7780f0.js";const a={},s=l(`<h1 id="常用-fn-个人整理与分享" tabindex="-1"><a class="header-anchor" href="#常用-fn-个人整理与分享" aria-hidden="true">#</a> 常用 FN 个人整理与分享</h1><hr><p>tips: 若有更好的方法希望能不吝指教!!!</p><blockquote><ol><li>选择任意物体子级</li></ol></blockquote><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>mapped fn fnSelectChildrens objSel =
(
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,9),r=[s];function d(t,c){return n(),i("div",null,r)}const v=e(a,[["render",d],["__file","maxscript.html.vue"]]);export{v as default};
