import{_ as e,W as n,X as i,a0 as a}from"./framework-2ec4eba7.js";const r={},d=a(`<h2 id="常用-fn-个人整理与分享" tabindex="-1"><a class="header-anchor" href="#常用-fn-个人整理与分享" aria-hidden="true">#</a> 常用 FN 个人整理与分享</h2><div class="custom-container tip"><p class="custom-container-title">*</p><p>若有更好的方法希望能不吝指教!!!</p></div><h3 id="_1-选择任意物体子级" tabindex="-1"><a class="header-anchor" href="#_1-选择任意物体子级" aria-hidden="true">#</a> 1. 选择任意物体子级</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>mapped fn fnSelectChildrens objSel =
(
