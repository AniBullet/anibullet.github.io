...
| 插件 | 安装位置 |
|:-----|:---------|
| GhostTrails | `{3dsMax安装目录}\plugins\` |
| AnimLibrary | `C:\ProgramData\Autodesk\ApplicationPlugins\AnimLibrary\` |
| AnimRef | `C:\ProgramData\Autodesk\ApplicationPlugins\AnimRef\` |
